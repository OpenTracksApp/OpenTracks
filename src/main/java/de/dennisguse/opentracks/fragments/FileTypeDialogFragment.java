...
public class FileTypeDialogFragment extends AbstractDialogFragment {
    ...
    protected Dialog createDialog() {
        ...
        final TrackFileFormat[] trackFileFormats = {TrackFileFormat.KMZ_WITH_TRACKDETAIL_AND_SENSORDATA_AND_PICTURES, TrackFileFormat.KML_WITH_TRACKDETAILS_AND_SENSORDATA, TrackFileFormat.GPX};
