 ...
 */
public class SingleTrackExporter {

    private static final String TAG = SingleTrackExporter.class.getSimpleName();

    private final ContentProviderUtils contentProviderUtils;
    private final Track track;
    private final TrackWriter trackWriter;

    public SingleTrackExporter(ContentProviderUtils contentProviderUtils, TrackWriter trackWriter, Track track) {
    ...
    public boolean writeTrack(@NonNull OutputStream outputStream) {
        try {
            ...
            writeWaypoints(track);
            trackWriter.writeBeginTracks();
            long startTime = track.getTrackStatistics().getStartTime_ms();
