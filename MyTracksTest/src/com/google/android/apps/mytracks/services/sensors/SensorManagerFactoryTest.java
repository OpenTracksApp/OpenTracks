...
public class SensorManagerFactoryTest extends AndroidTestCase {
  ...
  public void testCreateZephyr() throws Exception {
	assertClassForName(
	    ZephyrSensorManager.class, R.string.zephyr_sensor_type);
  }
  
  @SmallTest
  public void testCreateAnt() throws Exception {
	assertClassForName(
	    AntDirectSensorManager.class, R.string.ant_sensor_type);
  }

  @SmallTest
  public void testCreateAntSRM() throws Exception {
	assertClassForName(
	    AntSRMSensorManager.class, R.string.srm_ant_bridge_sensor_type);
  }
